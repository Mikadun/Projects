...
* Нахождение собственных значений матрицы методом вращений [[**Python**]])(https://github.com/JIeHb/Projects/blob/master/projects/nm_rotate_method.py) [[**Отчет**]](https://drive.google.com/file/d/1ysNNhY-sqIyR3hfjdQj4QQekNizMgJj9/view?usp=sharing)
